...
var BuildComponent = /** @class */ (function () {
    ...
    BuildComponent.prototype.onValidate = function () {
        return this.buildForm.valid;
    };
    BuildComponent.prototype.ngOnInit = function () {
        this.Build = this.appService.alm.development;
    };
    BuildComponent.prototype.ngDoCheck = function () {
        this.Build = this.appService.alm.development;
    };
    __decorate([
        core_1.ViewChild('buildForm'),
        __metadata("design:type", Object)
    ], BuildComponent.prototype, "buildForm", void 0);
